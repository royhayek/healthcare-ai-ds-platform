          ...
          <ReactMarkdown
            ...
            components={{
              ...
              code: ({ inline, children }: { inline?: boolean; children?: React.ReactNode }) =>
                inline ? (
                  <code className="bg-neutral-700 rounded px-1 py-0.5 font-mono text-xs">{children}</code>
                ) : (
                  <pre className="bg-neutral-700 rounded p-2 my-2 overflow-x-auto font-mono text-xs whitespace-pre">
                    <code>{children}</code>
                  </pre>
                ),
